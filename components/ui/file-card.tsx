...
export const FileCard = ({ formatFile }: FileCardProps) => {
    ...
    filePlaceholder = (
      <>
        <div className="bg-foreground/5 mb-1.5 space-y-1 rounded border p-1">
          ...
          <div className="bg-foreground/15 mx-auto h-0.5 w-8 rounded-full" />
        </div>
        <div className="mb-1 flex justify-center gap-1">
          <div className="bg-foreground/15 h-0.5 w-8 rounded-full" />
          <div className="bg-foreground/15 h-0.5 w-4 rounded-full" />
        </div>
        <div className="space-y-1">
          <div className="bg-foreground/15 h-0.5 w-4 rounded-full" />
          <div className="bg-foreground/15 h-0.5 w-5 rounded-full" />
        </div>
      </>
    );
  }
  ...
  if (
    ...
    filePlaceholder = (
      <div className="bg-foreground/5 mb-1.5 space-y-1 rounded border p-1">
        ...
        <div className="bg-foreground/15 mx-auto mt-1 h-0.5 w-4 rounded-full" />
        <div className="bg-foreground/15 mx-auto h-0.5 w-8 rounded-full" />
      </div>
    );
  }
  ...
  if (formatFile === "json") {
    filePlaceholder = (
      <div className="space-y-1">
        ...
        <div className="flex items-center gap-1 pl-1.5">
          <div className="bg-foreground/20 h-0.5 w-3 rounded-full" />
          <div className="bg-foreground/20 h-0.5 w-4 rounded-full" />
        </div>
        <div className="flex items-center gap-1 pl-1.5">
          <div className="bg-foreground/10 h-0.5 w-4 rounded-full" />
          <div className="bg-foreground/10 h-0.5 w-2 rounded-full" />
        </div>
        <div className="flex items-center gap-1 pl-1.5">
          <div className="bg-foreground/10 h-0.5 w-3 rounded-full" />
          <div className="bg-foreground/10 h-0.5 w-4 rounded-full" />
        </div>
        <div className="flex items-center gap-1 pl-1.5">
          <div className="bg-foreground/10 h-0.5 w-3 rounded-full" />
  ...
  return (
    <div aria-hidden className="relative size-fit">
      ...
      <div
        className={cn(
          "dark:bg-secondary ring-border relative z-10 space-y-3 rounded-md bg-white p-2 ring-1 w-14 h-[72px]"
        )}
      >
        {filePlaceholder}
      </div>
